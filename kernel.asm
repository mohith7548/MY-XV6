...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 43 75 10 80 	movl   $0x80107543,(%esp)
...
8010368f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103692:	c7 40 14 22 57 10 80 	movl   $0x80105722,0x14(%eax)
  p->context = (struct context*)sp;
...
80103746:	68 f5 74 10 80       	push   $0x801074f5
...
801037c0:	68 fc 74 10 80       	push   $0x801074fc
801037c5:	e8 c6 cb ff ff       	call   80100390 <panic>
    panic("mycpu called with interrupts enabled\n");
801037ca:	83 ec 0c             	sub    $0xc,%esp
801037cd:	68 1c 76 10 80       	push   $0x8010761c
...
80103843:	e8 a8 34 00 00       	call   80106cf0 <setupkvm>
...
80103861:	e8 6a 31 00 00       	call   801069d0 <inituvm>
...
801038cf:	68 25 75 10 80       	push   $0x80107525
801038d4:	50                   	push   %eax
801038d5:	e8 26 0e 00 00       	call   80104700 <safestrcpy>
  p->cwd = namei("/");
801038da:	c7 04 24 2e 75 10 80 	movl   $0x8010752e,(%esp)
...
80103913:	68 0c 75 10 80       	push   $0x8010750c
...
8010394c:	e8 6f 2f 00 00       	call   801068c0 <switchuvm>
  return 0;
...
8010396a:	e8 a1 31 00 00       	call   80106b10 <allocuvm>
...
8010398a:	e8 b1 32 00 00       	call   80106c40 <deallocuvm>
...
801039d8:	e8 e3 33 00 00       	call   80106dc0 <copyuvm>
...
80103ad7:	c7 04 24 30 75 10 80 	movl   $0x80107530,(%esp)
...
80103b15:	68 45 75 10 80       	push   $0x80107545
...
80103b52:	68 5c 75 10 80       	push   $0x8010755c
...
80103bc0:	e8 fb 2c 00 00       	call   801068c0 <switchuvm>
...
80103bd2:	e8 84 0b 00 00       	call   8010475b <swtch>
      switchkvm();
80103bd7:	e8 c4 2c 00 00       	call   801068a0 <switchkvm>
      c->proc = 0;
...
80103ddd:	68 bf 75 10 80       	push   $0x801075bf
80103de2:	e8 a9 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103de7:	83 ec 0c             	sub    $0xc,%esp
80103dea:	68 b2 75 10 80       	push   $0x801075b2
...
80103ef9:	68 d1 75 10 80       	push   $0x801075d1
80103efe:	e8 8d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f03:	83 ec 0c             	sub    $0xc,%esp
80103f06:	68 cb 75 10 80       	push   $0x801075cb
...
80103fa2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fa9:	e8 c2 2c 00 00       	call   80106c70 <freevm>
        release(&ptable.lock);
...
801040fb:	68 43 75 10 80       	push   $0x80107543
...
8010411e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104121:	ba e2 75 10 80       	mov    $0x801075e2,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104126:	77 11                	ja     80104139 <procdump+0x59>
80104128:	8b 14 85 44 76 10 80 	mov    -0x7fef89bc(,%eax,4),%edx
      state = "???";
8010412f:	b8 e2 75 10 80       	mov    $0x801075e2,%eax
...
80104141:	68 e6 75 10 80       	push   $0x801075e6
...
801041aa:	68 5c 76 10 80       	push   $0x8010765c
...
801043c5:	68 67 76 10 80       	push   $0x80107667
801043ca:	e8 c1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	68 7e 76 10 80       	push   $0x8010767e
...
801044b7:	68 85 76 10 80       	push   $0x80107685
...
8010450c:	68 8d 76 10 80       	push   $0x8010768d
...
8010492c:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
...
80104950:	68 95 76 10 80       	push   $0x80107695
...
80104ad5:	68 2b 77 10 80       	push   $0x8010772b
...
80104aea:	68 3a 77 10 80       	push   $0x8010773a
80104aef:	e8 9c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104af4:	83 ec 0c             	sub    $0xc,%esp
80104af7:	68 1c 77 10 80       	push   $0x8010771c
...
80104ee9:	58                   	pop    %eax
80104eea:	5a                   	pop    %edx
80104eeb:	68 38 77 10 80       	push   $0x80107738
...
80104f04:	68 37 77 10 80       	push   $0x80107737
...
80105573:	83 ec 08             	sub    $0x8,%esp
  exit();
80105576:	e8 55 e7 ff ff       	call   80103cd0 <exit>
...
80105583:	5d                   	pop    %ebp
  return wait();
80105584:	e9 87 e9 ff ff       	jmp    80103f10 <wait>
...
801055ae:	e8 ad ea ff ff       	call   80104060 <kill>
...
801055d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055d6:	e8 25 e2 ff ff       	call   80103800 <myproc>
...
801055f7:	78 27                	js     80105620 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055f9:	e8 02 e2 ff ff       	call   80103800 <myproc>
  if(growproc(n) < 0)
...
80105606:	e8 15 e3 ff ff       	call   80103920 <growproc>
...
8010567d:	e8 ce e7 ff ff       	call   80103e50 <sleep>
  while(ticks - ticks0 < n){
...
801056a5:	e8 26 ee ff ff       	call   801044d0 <release>
      return -1;
...
801056c8:	e8 03 ee ff ff       	call   801044d0 <release>
  return 0;
...
801056fe:	e8 cd ed ff ff       	call   801044d0 <release>
  return xticks;
}
...
80105747:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
8010574e:	08 00 00 8e 
80105752:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105759:	80 
8010575a:	c1 ea 10             	shr    $0x10,%edx
8010575d:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105764:	80 
  for(i = 0; i < 256; i++)
...
80105774:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105777:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
8010577e:	00 00 ef 
  initlock(&tickslock, "time");
80105781:	68 7d 77 10 80       	push   $0x8010777d
80105786:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010578b:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105791:	c1 e8 10             	shr    $0x10,%eax
80105794:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010579a:	e8 31 eb ff ff       	call   801042d0 <initlock>
}
...
801057bb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057bf:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105800:	ff 24 85 24 78 10 80 	jmp    *-0x7fef87dc(,%eax,4)
...
80105810:	e8 eb df ff ff       	call   80103800 <myproc>
...
80105830:	e8 ab df ff ff       	call   801037e0 <cpuid>
...
80105841:	e8 ba df ff ff       	call   80103800 <myproc>
80105846:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105849:	e8 b2 df ff ff       	call   80103800 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105865:	68 e0 77 10 80       	push   $0x801077e0
8010586a:	e8 f1 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010586f:	83 c4 20             	add    $0x20,%esp
80105872:	e8 89 df ff ff       	call   80103800 <myproc>
...
8010587e:	e8 7d df ff ff       	call   80103800 <myproc>
80105883:	85 c0                	test   %eax,%eax
80105885:	74 1d                	je     801058a4 <trap+0xc4>
80105887:	e8 74 df ff ff       	call   80103800 <myproc>
...
801058a4:	e8 57 df ff ff       	call   80103800 <myproc>
801058a9:	85 c0                	test   %eax,%eax
801058ab:	74 0b                	je     801058b8 <trap+0xd8>
801058ad:	e8 4e df ff ff       	call   80103800 <myproc>
...
801058b6:	74 68                	je     80105920 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058b8:	e8 43 df ff ff       	call   80103800 <myproc>
801058bd:	85 c0                	test   %eax,%eax
801058bf:	74 19                	je     801058da <trap+0xfa>
801058c1:	e8 3a df ff ff       	call   80103800 <myproc>
...
801058f2:	0f 85 e8 00 00 00    	jne    801059e0 <trap+0x200>
    myproc()->tf = tf;
801058f8:	e8 03 df ff ff       	call   80103800 <myproc>
801058fd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105900:	e8 0b f0 ff ff       	call   80104910 <syscall>
    if(myproc()->killed)
80105905:	e8 f6 de ff ff       	call   80103800 <myproc>
...
8010593d:	e8 1e ce ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105942:	e8 b9 de ff ff       	call   80103800 <myproc>
...
8010599f:	e8 3c de ff ff       	call   801037e0 <cpuid>
801059a4:	56                   	push   %esi
801059a5:	53                   	push   %ebx
801059a6:	50                   	push   %eax
801059a7:	68 88 77 10 80       	push   $0x80107788
...
801059b6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059b9:	e8 42 de ff ff       	call   80103800 <myproc>
...
801059ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
801059f0:	e8 db e2 ff ff       	call   80103cd0 <exit>
801059f5:	e9 aa fe ff ff       	jmp    801058a4 <trap+0xc4>
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a00:	83 ec 0c             	sub    $0xc,%esp
80105a03:	68 60 4d 11 80       	push   $0x80114d60
80105a08:	e8 03 ea ff ff       	call   80104410 <acquire>
      wakeup(&ticks);
80105a0d:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105a14:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105a1b:	e8 e0 e5 ff ff       	call   80104000 <wakeup>
      release(&tickslock);
80105a20:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a27:	e8 a4 ea ff ff       	call   801044d0 <release>
80105a2c:	83 c4 10             	add    $0x10,%esp
80105a2f:	e9 09 ff ff ff       	jmp    8010593d <trap+0x15d>
80105a34:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a37:	e8 a4 dd ff ff       	call   801037e0 <cpuid>
...
80105a45:	68 ac 77 10 80       	push   $0x801077ac
80105a4a:	e8 11 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a4f:	83 c4 14             	add    $0x14,%esp
80105a52:	68 82 77 10 80       	push   $0x80107782
...
80105b4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b4f:	bb a4 78 10 80       	mov    $0x801078a4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801066ba:	e8 61 de ff ff       	call   80104520 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010675d:	68 ac 78 10 80       	push   $0x801078ac
...
80106813:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106816:	e8 c5 cf ff ff       	call   801037e0 <cpuid>
...
801068e4:	0f 84 c2 00 00 00    	je     801069ac <switchuvm+0xec>
  pushcli();
801068ea:	e8 51 da ff ff       	call   80104340 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068ef:	e8 6c ce ff ff       	call   80103760 <mycpu>
801068f4:	89 c6                	mov    %eax,%esi
801068f6:	e8 65 ce ff ff       	call   80103760 <mycpu>
801068fb:	89 c7                	mov    %eax,%edi
801068fd:	e8 5e ce ff ff       	call   80103760 <mycpu>
80106902:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106905:	83 c7 08             	add    $0x8,%edi
80106908:	e8 53 ce ff ff       	call   80103760 <mycpu>
...
801069ff:	e8 1c db ff ff       	call   80104520 <memset>
...
80106a30:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a31:	e9 9a db ff ff       	jmp    801045d0 <memmove>
    panic("inituvm: more than a page");
80106a36:	83 ec 0c             	sub    $0xc,%esp
80106a39:	68 f1 78 10 80       	push   $0x801078f1
...
80106b5b:	e8 c0 d9 ff ff       	call   80104520 <memset>
...
80106b9d:	68 29 79 10 80       	push   $0x80107929
...
80106cdc:	68 5d 79 10 80       	push   $0x8010795d
...
80106d10:	e8 0b d8 ff ff       	call   80104520 <memset>
...
80106daf:	68 6e 79 10 80       	push   $0x8010796e
...
80106e00:	e8 cb d7 ff ff       	call   801045d0 <memmove>
...
80106e99:	68 92 79 10 80       	push   $0x80107992
80106e9e:	e8 ed 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ea3:	83 ec 0c             	sub    $0xc,%esp
80106ea6:	68 78 79 10 80       	push   $0x80107978
...
80106f2f:	e8 9c d6 ff ff       	call   801045d0 <memmove>
    len -= n;
    buf += n;

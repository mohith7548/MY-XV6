...
//    printf(1, "%s", *dirs[1]);
  ...
  2c:	e8 f1 02 00 00       	call   322 <open>
  ...
  3e:	68 e4 07 00 00       	push   $0x7e4
  43:	6a 01                	push   $0x1
  45:	e8 f6 03 00 00       	call   440 <printf>

    // close file descriptor (memory leaks)
    close(fd);
  4a:	89 34 24             	mov    %esi,(%esp)
  4d:	e8 b8 02 00 00       	call   30a <close>

    exit();
  52:	e8 8b 02 00 00       	call   2e2 <exit>
        printf(1, "Need only one argument\n");
  57:	53                   	push   %ebx
  58:	53                   	push   %ebx
  59:	68 b3 07 00 00       	push   $0x7b3
  5e:	6a 01                	push   $0x1
  60:	e8 db 03 00 00       	call   440 <printf>
        exit();
  65:	e8 78 02 00 00       	call   2e2 <exit>
        printf(1, "Need atleast one argument\n");
  6a:	56                   	push   %esi
  6b:	56                   	push   %esi
  6c:	68 98 07 00 00       	push   $0x798
  71:	6a 01                	push   $0x1
  ...
  7d:	52                   	push   %edx
  7e:	52                   	push   %edx
  7f:	68 cb 07 00 00       	push   $0x7cb
  84:	6a 01                	push   $0x1
  86:	e8 b5 03 00 00       	call   440 <printf>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 04 08 00 00       	mov    $0x804,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 767:	0a 00 00 
 76a:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 bc 0a 00 00       	mov    $0xabc,%eax
 779:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 780:	00 00 00 

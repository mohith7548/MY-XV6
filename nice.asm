...
main(int argc, char *argv[]) {
  ...
  4c:	76 13                	jbe    61 <main+0x61>
        printf(2, "Invalid priority! Choose between 0-20\n");
  4e:	51                   	push   %ecx
  4f:	51                   	push   %ecx
 ...
 601:	a1 94 0a 00 00       	mov    0xa94,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 94 0a 00 00       	mov    %eax,0xa94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 94 0a 00 00    	cmp    %eax,0xa94
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 94 0a 00 00    	mov    0xa94,%edx
 ...
 757:	0a 00 00 
 75a:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 98 0a 00 00       	mov    $0xa98,%eax

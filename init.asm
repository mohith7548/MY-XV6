...
*/
  ...
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 88 08 00 00       	push   $0x888
  46:	6a 01                	push   $0x1
  48:	e8 93 04 00 00       	call   4e0 <printf>
  printf(1, "\\ \\/ /\\ \\   / / /_   |___ \\  / _ \\ \n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  4f:	68 b0 08 00 00       	push   $0x8b0
  54:	6a 01                	push   $0x1
  56:	e8 85 04 00 00       	call   4e0 <printf>
  printf(1, " \\  /  \\ \\ / / '_ \\    __) || | | |\n");
  5b:	58                   	pop    %eax
  5c:	5a                   	pop    %edx
  5d:	68 d8 08 00 00       	push   $0x8d8
  62:	6a 01                	push   $0x1
  64:	e8 77 04 00 00       	call   4e0 <printf>
  printf(1, " /  \\   \\ V /| (_) |  / __/ | |_| |\n");
  69:	59                   	pop    %ecx
  6a:	5b                   	pop    %ebx
  6b:	68 00 09 00 00       	push   $0x900
  70:	6a 01                	push   $0x1
  72:	e8 69 04 00 00       	call   4e0 <printf>
  printf(1, "/_/\\_\\   \\_/  \\___/  |_____(_)___/ \n");
  77:	58                   	pop    %eax
  78:	5a                   	pop    %edx
  79:	68 28 09 00 00       	push   $0x928
  7e:	6a 01                	push   $0x1
  80:	e8 5b 04 00 00       	call   4e0 <printf>
  printf(1, "                                   \n");
  85:	59                   	pop    %ecx
  86:	5b                   	pop    %ebx
  87:	68 50 09 00 00       	push   $0x950
  8c:	6a 01                	push   $0x1
  ...
  d0:	68 7f 08 00 00       	push   $0x87f
  d5:	6a 01                	push   $0x1
  d7:	e8 04 04 00 00       	call   4e0 <printf>
  dc:	83 c4 10             	add    $0x10,%esp
  df:	eb df                	jmp    c0 <main+0xc0>
      printf(1, "init: fork failed\n");
  e1:	53                   	push   %ebx
  e2:	53                   	push   %ebx
  e3:	68 53 08 00 00       	push   $0x853
  e8:	6a 01                	push   $0x1
  ...
  f4:	50                   	push   %eax
  f5:	50                   	push   %eax
  f6:	68 28 0c 00 00       	push   $0xc28
  fb:	68 66 08 00 00       	push   $0x866
 100:	e8 c5 02 00 00       	call   3ca <exec>
      printf(1, "init: exec sh failed\n");
 105:	5a                   	pop    %edx
 106:	59                   	pop    %ecx
 107:	68 69 08 00 00       	push   $0x869
 10c:	6a 01                	push   $0x1
 ...
 119:	6a 01                	push   $0x1
 11b:	6a 01                	push   $0x1
 11d:	68 38 08 00 00       	push   $0x838
 122:	e8 b3 02 00 00       	call   3da <mknod>
    open("console", O_RDWR);
 127:	58                   	pop    %eax
 128:	5a                   	pop    %edx
 129:	6a 02                	push   $0x2
 12b:	68 38 08 00 00       	push   $0x838
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 80 09 00 00 	movzbl 0x980(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 78 09 00 00       	mov    $0x978,%ebx
        while(*s != 0){
 ...
 6b1:	a1 30 0c 00 00       	mov    0xc30,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 30 0c 00 00       	mov    %eax,0xc30
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 30 0c 00 00       	mov    %eax,0xc30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 30 0c 00 00    	cmp    %eax,0xc30
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 30 0c 00 00    	mov    0xc30,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 30 0c 00 00    	mov    %edx,0xc30
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 30 0c 00 00 34 	movl   $0xc34,0xc30
 807:	0c 00 00 
 80a:	c7 05 34 0c 00 00 34 	movl   $0xc34,0xc34
 811:	0c 00 00 
    base.s.size = 0;
 814:	b8 34 0c 00 00       	mov    $0xc34,%eax
 819:	c7 05 38 0c 00 00 00 	movl   $0x0,0xc38
 820:	00 00 00 

...
main(void)
{
  ...
  23:	0f 88 ef 00 00 00    	js     118 <main+0x118>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 d7 03 00 00       	call   40a <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 cb 03 00 00       	call   40a <dup>
                                   
*/

  // Add Banner saying "Xv6 2.0"
  // clear();
  printf(1, "                       __  ____     ____     ____    ___  \n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 98 08 00 00       	push   $0x898
  46:	6a 01                	push   $0x1
  48:	e8 a3 04 00 00       	call   4f0 <printf>
  printf(1, "                       \\ \\/ /\\ \\   / / /_   |___ \\  / _ \\ \n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  4f:	68 d4 08 00 00       	push   $0x8d4
  54:	6a 01                	push   $0x1
  56:	e8 95 04 00 00       	call   4f0 <printf>
  printf(1, "                        \\  /  \\ \\ / / '_ \\    __) || | | |\n");
  5b:	58                   	pop    %eax
  5c:	5a                   	pop    %edx
  5d:	68 10 09 00 00       	push   $0x910
  62:	6a 01                	push   $0x1
  64:	e8 87 04 00 00       	call   4f0 <printf>
  printf(1, "                        /  \\   \\ V /| (_) |  / __/ | |_| |\n");
  69:	59                   	pop    %ecx
  6a:	5b                   	pop    %ebx
  6b:	68 4c 09 00 00       	push   $0x94c
  70:	6a 01                	push   $0x1
  72:	e8 79 04 00 00       	call   4f0 <printf>
  printf(1, "                       /_/\\_\\   \\_/  \\___/  |_____(_)___/ \n");
  77:	58                   	pop    %eax
  78:	5a                   	pop    %edx
  ...
  a3:	68 50 08 00 00       	push   $0x850
  a8:	6a 01                	push   $0x1
  aa:	e8 41 04 00 00       	call   4f0 <printf>
    pid = fork();
  af:	e8 d6 02 00 00       	call   38a <fork>
    if(pid < 0){
  ...
  b9:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  bb:	78 24                	js     e1 <main+0xe1>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  bd:	74 35                	je     f4 <main+0xf4>
  bf:	90                   	nop
      exec("sh", argv);
  ...
  c0:	e8 d5 02 00 00       	call   39a <wait>
  c5:	85 c0                	test   %eax,%eax
  c7:	78 d7                	js     a0 <main+0xa0>
  c9:	39 c3                	cmp    %eax,%ebx
  cb:	74 d3                	je     a0 <main+0xa0>
      printf(1, "zombie!\n");
  cd:	83 ec 08             	sub    $0x8,%esp
  d0:	68 8f 08 00 00       	push   $0x88f
  d5:	6a 01                	push   $0x1
  d7:	e8 14 04 00 00       	call   4f0 <printf>
  dc:	83 c4 10             	add    $0x10,%esp
  df:	eb df                	jmp    c0 <main+0xc0>
      printf(1, "init: fork failed\n");
  e1:	53                   	push   %ebx
  e2:	53                   	push   %ebx
  e3:	68 63 08 00 00       	push   $0x863
  e8:	6a 01                	push   $0x1
  ea:	e8 01 04 00 00       	call   4f0 <printf>
      exit();
  ef:	e8 9e 02 00 00       	call   392 <exit>
      exec("sh", argv);
  f4:	50                   	push   %eax
  f5:	50                   	push   %eax
  f6:	68 b0 0c 00 00       	push   $0xcb0
  fb:	68 76 08 00 00       	push   $0x876
 100:	e8 c5 02 00 00       	call   3ca <exec>
      printf(1, "init: exec sh failed\n");
 105:	5a                   	pop    %edx
 106:	59                   	pop    %ecx
 107:	68 79 08 00 00       	push   $0x879
 10c:	6a 01                	push   $0x1
 ...
 119:	6a 01                	push   $0x1
 11b:	6a 01                	push   $0x1
 11d:	68 48 08 00 00       	push   $0x848
 122:	e8 b3 02 00 00       	call   3da <mknod>
    open("console", O_RDWR);
 127:	58                   	pop    %eax
 128:	5a                   	pop    %edx
 129:	6a 02                	push   $0x2
 12b:	68 48 08 00 00       	push   $0x848
 130:	e8 9d 02 00 00       	call   3d2 <open>
 135:	83 c4 10             	add    $0x10,%esp
 138:	e9 ec fe ff ff       	jmp    29 <main+0x29>
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 08 0a 00 00 	movzbl 0xa08(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 00 0a 00 00       	mov    $0xa00,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 b8 0c 00 00       	mov    0xcb8,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 b8 0c 00 00       	mov    %eax,0xcb8
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 b8 0c 00 00       	mov    %eax,0xcb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 b8 0c 00 00    	mov    0xcb8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 b8 0c 00 00    	cmp    %eax,0xcb8
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 b8 0c 00 00    	mov    0xcb8,%edx
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
}
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 b8 0c 00 00 bc 	movl   $0xcbc,0xcb8
 817:	0c 00 00 
 81a:	c7 05 bc 0c 00 00 bc 	movl   $0xcbc,0xcbc
 821:	0c 00 00 
    base.s.size = 0;
 824:	b8 bc 0c 00 00       	mov    $0xcbc,%eax
 829:	c7 05 c0 0c 00 00 00 	movl   $0x0,0xcc0
 830:	00 00 00 

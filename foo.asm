...
int main(int argc, char *argv[]) {
  ...
  3d:	83 c3 01             	add    $0x1,%ebx
			printf(1, "Parent %d creating child %d\n", getpid(), id);
  40:	68 3b 08 00 00       	push   $0x83b
  45:	6a 01                	push   $0x1
  47:	e8 84 04 00 00       	call   4d0 <printf>
			wait();
  ...
  82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
			for(z = 0; z < 8000000.0; z +=d)
				x = x + 3.14 * 89.64;		// Useless-To keep CPU busy
			break;
		}
	}
	exit();
  ...
  eb:	d9 05 6c 08 00 00    	flds   0x86c
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 70 08 00 00       	mov    $0x870,%ebx
        while(*s != 0){
 ...
 6a1:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 7f7:	0b 00 00 
 7fa:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
 809:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 810:	00 00 00 

 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 48 07 00 00 	movzbl 0x748(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 3e 07 00 00       	mov    $0x73e,%ebx
        while(*s != 0){
 ...
 5a1:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 ec 09 00 00       	mov    %eax,0x9ec
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 ec 09 00 00       	mov    %eax,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 ec 09 00 00    	cmp    %eax,0x9ec
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 ec 09 00 00 f0 	movl   $0x9f0,0x9ec
 6f7:	09 00 00 
 6fa:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 701:	09 00 00 
    base.s.size = 0;
 704:	b8 f0 09 00 00       	mov    $0x9f0,%eax
 709:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 710:	00 00 00 
